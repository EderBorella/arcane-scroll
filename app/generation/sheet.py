...
code-resolved subclass) are injected by code. Feature choices (fighting style, expertise, … — see
features.py) are merged on top; feats/ASI and equipment come next."""
import random

from app.generation import client, features
