...
from validator.checks import ability_scores, class_level, spellcasting, vitals
from validator.report import ERROR, INTERNAL, WARNING, Violation

DEFAULT_CHECKS = [class_level.check, ability_scores.check, spellcasting.check, vitals.check]
