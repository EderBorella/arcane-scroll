...
from validator.checks import abilities, defenses, feats, identity, movement, proficiencies, saving_throws, senses, spellcasting, vitals

ALL_CHECKS = [identity.check, abilities.check, saving_throws.check, vitals.check, proficiencies.check,
              feats.check, spellcasting.check, senses.check, movement.check, defenses.check]
